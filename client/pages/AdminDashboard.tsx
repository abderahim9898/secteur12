...
export default function AdminDashboard() {
  ...
  const navigationCards = [
    ...
    {
      title: 'Gestion des motifs de sortie',
      description: 'Gérer les raisons/smotifs de sortie des ouvriers',
      icon: AlertTriangle,
      path: '/admin/motifs',
      color: 'from-yellow-500 to-yellow-600',
      stats: `${/* motifs count placeholder */ 0} motifs`,
      actions: ['Lister', 'Ajouter', 'Supprimer'],
      priority: 'medium'
    },
    {
